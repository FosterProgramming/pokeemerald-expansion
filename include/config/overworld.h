...
#define OW_FLAG_NO_COLLISION        FLAG_TEMP_1F  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
