#ifndef GUARD_DEBUG_SCRIPTING_H
#define GUARD_DEBUG_SCRIPTING_H
...
extern const u8 *const gBytecodeToString[];
extern const u8 *const gMapScriptTypeStrings[];
extern const u8 *const gSpecialStrings[];
extern u8 gActiveScriptDebugger;

void ActivateScriptDebugger(void);
void DeactivateScriptDebugger(void);

#endif
#endif // GUARD_DEBUG_SCRIPTING_H