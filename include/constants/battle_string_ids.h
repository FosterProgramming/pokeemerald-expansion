...
enum StringID
{
    ...
    STRINGID_DISLIKECONTESTMOVE,
    STRINGID_NEUTRALCONTESTMOVE,
    STRINGID_LIKECONTESTMOVE,
    STRINGID_PKMNSTARING,
    STRINGID_PKMNHISSING,
    STRINGID_PKMNPRETENDING,
    STRINGID_PKMNHOPPING,
    STRINGID_PKMNSHAKING,
    STRINGID_TRYTOTHROWBERRY,
    STRINGID_PKMNISEATINGBERRY,
    STRINGID_PKMNLOVESBERRY,
    STRINGID_PKMNISTRYINGTOESCAPE,
    STRINGID_PKMNSENTTOPROFESSOR,
    STRINGID_COUNT
};
