...
#define STATUS_FIELD_EXTRA_AP_TERRAIN               (1 << 12)
#define STATUS_FIELD_SLOW_AP_TERRAIN                (1 << 13)

#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_EXTRA_AP_TERRAIN | STATUS_FIELD_SLOW_AP_TERRAIN)
...
enum MoveEffects
{
    ...
    MOVE_EFFECT_AP_MOD,
    MOVE_EFFECT_EXTRA_AP_TERRAIN,
    MOVE_EFFECT_SLOW_AP_TERRAIN,
    NUM_MOVE_EFFECTS
};
...
enum StartingStatus
{
    ...
    STARTING_STATUS_EXTRA_AP_TERRAIN,
    STARTING_STATUS_SLOW_AP_TERRAIN,
