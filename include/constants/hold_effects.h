...
enum ItemHoldEffect
{
    ...
    HOLD_EFFECT_CONFUSE_SWEET, //Working
    HOLD_EFFECT_CONFUSE_BITTER,//Working
    HOLD_EFFECT_CONFUSE_SOUR,  //Working
    ...
    //Custom
    HOLD_EFFECT_ETERNAL_CREST,
    HOLD_EFFECT_HEART_OF_EVOLUTION,
    HOLD_EFFECT_SKY_EMPEROR_CROWN,
    HOLD_EFFECT_SKY_PIERCER,
    HOLD_EFFECT_GLIDED_EMBLEM,
    HOLD_EFFECT_SPECTRAL_COCOON,
    HOLD_EFFECT_COMPOUND_SCOPE,
    HOLD_EFFECT_BLINDING_GEM,
};
