export const tilesetsData = {
    ...
    "gTileset_NiagaraWoodsPrimary": {
        folder: "niagarawoodsprimary/anim",
        primary: true,
        tileAnimations: {
            214: { // (0x0d6)
                folder: "water",
                frames: ["animated_water0000", "animated_water0001", "animated_water0002", "animated_water0003", "animated_water0004", "animated_water0005", "animated_water0006", "animated_water0007"],
                numTiles: 4,
                interval: 8,
                imageWidth: 16,
            },
    ...
    "gTileset_GeneralSeelVersion": {
        folder: "general_seel_version/anim",
        primary: true,
        tileAnimations: {
            1: { // (0x1FC)
                folder: "flower_blue",
    ...
    "gTileset_TheGreatSea": {
        folder: "the_great_sea/anim",
        primary: true,
        tileAnimations: {
            1: { // (0x1F0)
                folder: "deep_water",
            ...
            41: { // (0x1F0)
                folder: "sand_water_edge_sea_rocks",
                frames: ["0", "1", "2", "3", "4", "5", "6", "7"],
                numTiles: 10,
                interval: 16,
                imageWidth: 80,
    ...
    "gTileset_MurkwellBog": {
        folder: "murkwell_bog/anim",
        primary: false,
        tileAnimations: {
            512: { // (0x200)
                folder: "lilypads",
    ...
    "gTileset_StratoscapePrimary": {
        folder: "stratoscape_primary/anim",
        primary: true,
        tileAnimations: {
            1: { // (0x000)
                folder: "land_water_edge",
