...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{B_BUFF1} grew to Lv. {B_BUFF2} and gained\n{B_BUFF3} skill points!{WAIT_SE}\p"),
    [STRINGID_PKMNGREWTOLV_NO_SKILL]                = COMPOUND_STRING("{B_BUFF1} grew to Lv. {B_BUFF2}!{WAIT_SE}\p"),
    ...
    [STRINGID_GLIDEDEMBLEM]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} restored a little HP using its {B_LAST_ITEM}!"),
    ...
    [STRINGID_SCORCHEDENGINEACTIVATED]              = COMPOUND_STRING("{B_DEF_ABILITY} activated and boosted {B_DEF_NAME_WITH_PREFIX}'s AP!"), //not in gen 5+, ability popup
    ...
    [STRINGID_VEEFIRSTTRANSFORMDIALOGUE]            = COMPOUND_STRING("Vee: Huh?! W-wait--what just happened?!\pI feel--different! My fur--it's all\nweird and--OH! I'm changing?!?!\pDid YOU do this? Did I do this?!\pThe scientists said I was a failure...\pBut look at me now!\pThey were WRONG!\pOkaaay, I have no idea how this\nworks, but I'm gonna roll with it!\pLet's go!"),
    ...
    [STRINGID_LASTABILITYRAISEDAP]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_LAST_ABILITY} raised its AP!"),
};
