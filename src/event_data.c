...
void ClearTempFieldEventData(void)
{
    ...
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_1, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_2, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_3, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_4, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_5, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_6, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_7, BOULDER_SWITCH_NOT_PRESSED);
    VarSet(VAR_TEMP_BOULDER_SWITCH_OBJECT_ID_8, BOULDER_SWITCH_NOT_PRESSED);

    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_1, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_2, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_3, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_4, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_5, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_6, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_7, BOULDER_SWITCH_NO_EVENT);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_8, BOULDER_SWITCH_NO_EVENT);
}
