...
void ClearTempFieldEventData(void)
{
    ...
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_1, 0);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_2, 0);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_3, 0);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_4, 0);
    VarSet(VAR_TEMP_BOULDER_SWITCH_EVENT_ID_5, 0);
}
