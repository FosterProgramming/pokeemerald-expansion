...
static void Overworld_ResetStateAfterWhiteOut(void)
{
    ...
    VarSet(VAR_ENEMY_1_SPECIES, SPECIES_NONE);
    VarSet(VAR_ENEMY_1_CUSTOM_MAX_HP, SPECIES_NONE);
    ...
    VarSet(VAR_ENEMY_2_SPECIES, SPECIES_NONE);
    VarSet(VAR_ENEMY_2_CUSTOM_MAX_HP, SPECIES_NONE);
    VarSet(VAR_ENEMY_2_ABILITY_OVERWRITE_1, 0);
    VarSet(VAR_ENEMY_2_ABILITY_OVERWRITE_2, 0);
    VarSet(VAR_ENEMY_2_ABILITY_OVERWRITE_3, 0);
    VarSet(VAR_ENEMY_2_ABILITY_OVERWRITE_4, 0);
...
void CB2_NewGame(void)
{
    ...
    // gFieldCallback = ExecuteTruckSequence; //truck shake
    gFieldCallback2 = NULL;
