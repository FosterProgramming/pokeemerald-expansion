...
const u8 sItemIngredientSettings[ITEMS_COUNT] =
{
    ...
    [ITEM_ORAN_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_SITRUS_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_POMEG_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_KEE_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_MARANGA_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_PECHA_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_RAWST_BERRY] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_FRESH_WATER] = 1u << INGREDIENT_CATEGORY_FLUID | ITEM_IS_CONSUMED_ON_ATTEMPT,
    [ITEM_ABSORB_BULB] = 1u << INGREDIENT_CATEGORY_BERRIES | ITEM_IS_CONSUMED_ON_ATTEMPT,
};
