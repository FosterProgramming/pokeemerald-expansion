...
static const struct FormChange sEeveeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_VAPOREON, TYPE_WATER},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_FLAREON, TYPE_FIRE},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_JOLTEON, TYPE_ELECTRIC},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_EEVEE, TYPE_NORMAL},
