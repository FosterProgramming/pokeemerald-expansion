...
static const struct FormChange sEeveeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_VAPOREON, TYPE_WATER, NULL},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_FLAREON, TYPE_FIRE, NULL},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_JOLTEON, TYPE_ELECTRIC, NULL},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_TYPE, SPECIES_EEVEE, TYPE_NORMAL, NULL},
    {FORM_CHANGE_BATTLE_SWITCH,               SPECIES_EEVEE},
