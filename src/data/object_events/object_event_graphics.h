const u32 gObjectEventPic_BrendanNormalRunning[] = INCBIN_U32("graphics/pokemon/dewgong/overworld.4bpp", "graphics/object_events/pics/people/brendan/running.4bpp");
