...
const union AnimCmd *const sAnimTable_Dewgong[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth2F,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest2F,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast2F,
    ...
    [ANIM_STD_GO_FAST_EAST] = sAnim_GoFastEast2F,
    // 'Faster' and above used for entering/exiting pokeball
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_GoSouth2F,
    [ANIM_STD_GO_FASTER_NORTH] = sAnim_GoNorth2F,
    [ANIM_STD_GO_FASTER_WEST] = sAnim_GoWest2F,
    [ANIM_STD_GO_FASTER_EAST] = sAnim_GoEast2F,
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_GoSouth2F,
    [ANIM_STD_GO_FASTEST_NORTH] = sAnim_GoNorth2F,
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_GoWest2F,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_GoEast2F,
    [ANIM_RUN_SOUTH] = sAnim_GoSouth2F,
    [ANIM_RUN_NORTH] = sAnim_GoNorth2F,
    [ANIM_RUN_WEST] = sAnim_GoWest2F,
    [ANIM_RUN_EAST] = sAnim_GoEast2F,
};
