static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DOMINION_CITY - 1] = {MAP_GROUP(DOMINION_CITY), MAP_NUM(DOMINION_CITY), 10, 10},
    [HEAL_LOCATION_EMBERGLIDE - 1] = {MAP_GROUP(EMBERGLIDE), MAP_NUM(EMBERGLIDE), 10, 10},
    [HEAL_LOCATION_PYRODEN - 1] = {MAP_GROUP(PYRODEN), MAP_NUM(PYRODEN), 19, 35},
    [HEAL_LOCATION_VERDANT_HALLOW - 1] = {MAP_GROUP(VERDANT_HALLOW), MAP_NUM(VERDANT_HALLOW), 11, 11},
    [HEAL_LOCATION_MURKWELL_BOG - 1] = {MAP_GROUP(MURKWELL_BOG), MAP_NUM(MURKWELL_BOG), 48, 42},
    [HEAL_LOCATION_DUNEMIRE - 1] = {MAP_GROUP(DUNEMIRE), MAP_NUM(DUNEMIRE), 34, 17},
    [HEAL_LOCATION_VOLTBROOK_TOWN - 1] = {MAP_GROUP(VOLTBROOK_TOWN), MAP_NUM(VOLTBROOK_TOWN), 5, 24},
    [HEAL_LOCATION_DRIFTSHORE - 1] = {MAP_GROUP(DRIFTSHORE), MAP_NUM(DRIFTSHORE), 12, 17},
    [HEAL_LOCATION_MOONTHISTLE - 1] = {MAP_GROUP(MOONTHISTLE), MAP_NUM(MOONTHISTLE), 13, 25},
    [HEAL_LOCATION_DOMINION_CITY_MAGA_LAB_HOLDING_CELLS - 1] = {MAP_GROUP(DOMINION_CITY_MAGA_LAB_HOLDING_CELLS), MAP_NUM(DOMINION_CITY_MAGA_LAB_HOLDING_CELLS), 6, 3},
    [HEAL_LOCATION_STRATOSCAPE - 1] = {MAP_GROUP(STRATOSCAPE), MAP_NUM(STRATOSCAPE), 33, 27},
    [HEAL_LOCATION_VOLTBROOK_TOWN_POWER_PLANT - 1] = {MAP_GROUP(VOLTBROOK_TOWN_POWER_PLANT_UNDERGROUND_TUNNEL), MAP_NUM(VOLTBROOK_TOWN_POWER_PLANT_UNDERGROUND_TUNNEL), 8, 25},
};
