static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_MURKWELL_BOG - 1] = {MAP_GROUP(MURKWELL_BOG), MAP_NUM(MURKWELL_BOG), 27, 25},
    [HEAL_LOCATION_DUNEMIRE - 1] = {MAP_GROUP(DUNEMIRE), MAP_NUM(DUNEMIRE), 34, 17},
    [HEAL_LOCATION_VOLTBROOK_TOWN - 1] = {MAP_GROUP(VOLTBROOK_TOWN), MAP_NUM(VOLTBROOK_TOWN), 10, 10},
    [HEAL_LOCATION_DRIFTSHORE - 1] = {MAP_GROUP(DRIFTSHORE), MAP_NUM(DRIFTSHORE), 12, 17},
    [HEAL_LOCATION_UNNAMED_TOWN - 1] = {MAP_GROUP(UNNAMED_TOWN), MAP_NUM(UNNAMED_TOWN), 20, 16},
