...
const u8 gText_12PoofForgotMoveEnd[] = _("1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SafariBallStock[] = _("SAFARI PROGRESS\nStock: {STR_VAR_1}\nScore: {STR_VAR_2}\nTimer:  {STR_VAR_3}");
