...
static const struct MatchCallTrainerTextInfo sMatchCallTrainers[] =
{
    ...
    {
        .trainerId = TRAINER_GRUNT_SECURITY_HALLWAY_9,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(8),
    ...
    {
        .trainerId = TRAINER_GRUNT_SECURITY_HALLWAY_1,
        .unused = 0,
        // Thalia and Sawyer are the only ones who use different msg ids for their battle topics
...
{
    int callChance = 1;
    if (!GetMonData(&gPlayerParty[0], MON_DATA_SANITY_IS_EGG) && MonHasTrait(&gPlayerParty[0], ABILITY_LIGHTNING_ROD, TRUE))
        callChance = 2;
