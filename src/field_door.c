...
static const u8 sDoorAnimTiles_LabHoldingCell[] = INCBIN_U8("graphics/door_anims/lab_holding_cell.4bpp");
static const u16 sDoorNullPalette50[16] = {};
static const u8 sDoorAnimTiles_PowerPlant[] = INCBIN_U8("graphics/door_anims/power_plant.4bpp");
...
static const u8 sDoorAnimPalettes_LabHoldingCell[] = {6, 6, 6, 6, 6, 6, 6, 6};
static const u8 sDoorAnimPalettes_PowerPlant[] = {6, 6, 7, 7, 7, 7, 7, 7};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Lab_Door_HoldingCell,                         DOOR_SOUND_NORMAL, 1,  sDoorAnimTiles_LabHoldingCell, sDoorAnimPalettes_LabHoldingCell},
    {METATILE_PowerPlant_Vent,                              DOOR_SOUND_NORMAL, 1,  sDoorAnimTiles_PowerPlant, sDoorAnimPalettes_PowerPlant},
    {},
};
